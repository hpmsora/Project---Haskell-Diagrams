...
diagram1 = atPoints (trailVertices $ regPoly 10 1) (repeat diagram2)

diagram2 :: Diagram SVG
diagram2 = atPoints (trailVertices $ regPoly 10 1) (repeat diagram3)

diagram3 :: Diagram SVG
diagram3 = atPoints (trailVertices $ regPoly 10 1) (repeat (strokeLine (f 40)))

f :: Int -> Trail' Line V2 Double
f 0 = mempty
f n = onLineSegments tail (square 0.1)
