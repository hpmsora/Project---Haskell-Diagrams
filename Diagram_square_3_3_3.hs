...
diagram1 = atPoints (trailVertices $ regPoly 3 1) (repeat diagram2)

diagram2 :: Diagram SVG
diagram2 = atPoints (trailVertices $ regPoly 3 1) (repeat diagram3)

diagram3 :: Diagram SVG
diagram3 = atPoints (trailVertices $ regPoly 3 1) (repeat (strokeLine (f 40)))
